...
contract Solulab is ERC20, Ownable{
    constructor()ERC20("Solulab", "SLB"){
...
contract Crowdsale {
  ...
  constructor(uint256 _pre_sale_rate, uint256 _seed_sale_rate, address _wallet, ERC20 _token) {
  ...
  function sale_price()internal view returns(uint256){
       if(cap < preSaleSupply)
           return pre_sale_rate;
           else if(cap < seedSaleSupply)
           return seed_sale_rate;
           else
